...
| Course | Contents |
|--------|----------|
| **Artificial Intelligence** | 15-week course — Part 1: RL fundamentals (MDP, Bellman, Q-Learning, DQN, PPO); Part 2: LLMs & Agentic AI (Transformers, LoRA, RLHF, ReAct, RAG, Multi-Agent, Safety) |
